...
class RuleClassifier(BaseClassifier):
    ...
    def __init__(self) -> None:
        ...
        # Pre-compile all regex patterns so we pay the compilation cost
    ...
    def classify(self, event: RawEvent) -> ClassificationResult:
        ...
        # Look up the trust weight for this source and fallback unknown if not found
        ...
        notes.append(f"No threshold met — defaulting to P4")
        return ClassificationResult(
    ...
    def _compile_rules(
        ...
        #Walk through the severity config from YAML, pre-compileevery regex pattern string to objkect
